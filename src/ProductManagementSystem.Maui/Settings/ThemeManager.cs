...
namespace ProductManagementSystem.Maui.Settings;
...
public class ThemeManager : ISingletonDependency
{
    ...
    {
        var storedTheme = await _storage.GetAsync(ProductManagementSystemConsts.Settings.Theme);
    ...
    public async Task SetAppThemeAsync(AppTheme theme)
    {
        ...
        await _storage.SetAsync(ProductManagementSystemConsts.Settings.Theme, theme.ToString());
    }
}