...
namespace ProductManagementSystem.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("ProductManagementSystem") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "ProductManagementSystem", DisplayName = "ProductManagementSystem API", Resources = { "ProductManagementSystem" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        //Web Client
        var webClientId = configurationSection["ProductManagementSystem_Web:ClientId"];
        if (!webClientId.IsNullOrWhiteSpace())
        {
            var webClientRootUrl = configurationSection["ProductManagementSystem_Web:RootUrl"]!.EnsureEndsWith('/');

            /* ProductManagementSystem_Web client is only needed if you created a tiered
            ...
            await CreateApplicationAsync(
                ...
                secret: configurationSection["ProductManagementSystem_Web:ClientSecret"] ?? "1q2w3e*",
        ...
        var consoleAndAngularClientId = configurationSection["ProductManagementSystem_App:ClientId"];
        if (!consoleAndAngularClientId.IsNullOrWhiteSpace())
        {
            var consoleAndAngularClientRootUrl = configurationSection["ProductManagementSystem_App:RootUrl"]?.TrimEnd('/');
            await CreateApplicationAsync(
        ...
        var mauiScopes = new List<string>
    {
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["ProductManagementSystem_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["ProductManagementSystem_Swagger:RootUrl"]?.TrimEnd('/');
