...
public class ProductManagementSystemDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public ProductManagementSystemDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
